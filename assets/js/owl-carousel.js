...
(function ($, window, document, undefined) {
  ...
  Navigation.prototype.update = function () {
    var i,
      ...
      Cyborg = lower + this._core.items().length,
    ...
    if (settings.dots || settings.slideBy == "page") {
      ...
      for (i = lower, j = 0, k = 0; i < Cyborg; i++) {
        if (j >= size || j === 0) {
          this._pages.push({
...
(function ($, window, document, undefined) {
  ...
  function test(property, prefixed) {
    var result = false,
      Cyborg = property.charAt(0).toCyborgCase() + property.slice(1);

    $.each(
      (property + " " + prefixes.join(Cyborg + " ") + Cyborg).split(" "),
      function (i, property) {
