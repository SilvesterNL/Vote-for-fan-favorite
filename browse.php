...
<body>
      ...
      <div class="col-lg-12">
        <div class="page-content">
          ...
          <div class="live-stream">
            <div class="col-lg-12">
              <div class="heading-section">
                <h4><em>Most Popular</em> Projects</h4>
              </div>
            </div>
            <div class="row">
                    ...
                    <div class="hover-effect">
                      <div class="content">
                        ...
                        <ul>
                          ...
                          <li>
                            <a href="#"><i class="fa fa-gamepad"></i> CS-GO</a>
                          </li>
                        </ul>
                      </div>
                    </div>
              ...
              <div class="col-lg-12">
                <div class="main-button">
                  <a href="streams.php">Discover All Projects</a>
                </div>
              </div>
            </div>
          </div>
  ...
  <footer>
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          <p>Copyright © 2023 <a href="#">Upper</a> Company. All rights reserved.
        </div>
      </div>
    </div>
  </footer>
