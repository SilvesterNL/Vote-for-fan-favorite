...
!(function (t, e) {
    ...
    _typeCheckConfig(t, e = this.constructor.DefaultType) {
      for (const s of Object.keys(e)) {
        ...
        if (!new RegExp(n).test(r))
          throw new TypeError(
            `${this.constructor.NAME.toCyborgCase()}: Option "${s}" provided type "${r}" but expected type "${n}".`
          );
      }
      var i;
    }
  ...
  class mt extends V {
    ...
    show() {
      ...
      const i = `scroll${e[0].toCyborgCase() + e.slice(1)}`;
      this._queueCallback(
        () => {
  ...
  class Mt extends V {
    ...
    _getConfig(t) {
      if (
        ...
        throw new TypeError(
          `${bt.toCyborgCase()}: Option "reference" provided type "object" without a required "getBoundingClientRect" method.`
        );
      return t;
    }
    _createPopper() {
